...
- The dashboard's logic is unit-tested in a real (headless) Chrome browser.
...
The same backend also powers a [React version of this dashboard](https://github.com/mauri0686/realtime-logistics-dashboard-react),
